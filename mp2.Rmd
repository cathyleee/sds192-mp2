...
We want to know how much advocating money and how many votes each party received in house elections in 2012 to compare them against each other and see ifthe two bar graphs show similar patterns.
```{r, warning = FALSE}
