...
We drew bar graphs in a descending order of y-axis. We can see that Republican and Democratic are the two parties that account for most votes, most money, and most wins, overwhelming more than any other party. Republicans outdid Democrats in all three aspects in house elections in 2012. Looking more closely, however, we see that Republicans received significantly more donations than Democrats, but only slightly more votes, indicating that more money invested does not necessarily lead to more votes.
