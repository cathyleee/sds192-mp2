...
contributions_2012 <- contributions %>% 
  ...
  group_by(cand_id) %>%
  summarize(N = n(),
            total_amt_per_can = sum(transaction_amt), cand_party = cand_party_affiliation)
```
...
contributions_2012_per_party %>%
  ...
  scale_x_discrete(labels = c("R" = "Republican", "D" = "Democratic", "U" = "Unknown", "L" = "Libertarian", "I" = "Independent")) # leave "W" and "N" as is because we don't know for sure what they stand for 
```
